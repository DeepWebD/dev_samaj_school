...
import { nehrunagar } from "./mockdata/NehruNagar";
import { sukhdevNagar } from "./mockdata/SukhdevNagar";
...
const App = () => {
  const { selectedSchoolName } = useSchool();
  const schoolData =
    selectedSchoolName === "nehruNagar" ? nehrunagar : sukhdevNagar;
  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route path="/" element={<RootLayout />}>
        <Route
          index
          element={<Home schoolName="nehruNagar" schoolData={schoolData} />}
        />
        ...
        <Route
          path="contact"
          element={<ContactUs contactUs={schoolData?.homePage?.contactUs} />}
        ></Route>
