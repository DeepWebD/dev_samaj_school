import image6 from "../../public/vision2.jpg";
import HeroImg from "../../public/visionhero.jpeg";
    ...
    <>
        ...
        <div className="container max-w-7xl px-4 sm:px-6 lg:px-8 z-10">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-2 text-pretty text-lg font-thin text-white sm:text-xl/8 ">
              Keeping in view the vision of Revered Bhagwan Dev Atma to empower
        ...
        >
          <div className="text-center md:text-left space-y-6">
            ...
            <p className="font-light text-lg">
              To shape, sensitize and inculcate scientific temper combined with
              right attitudes, values and ideologies in the prospective
              teachers.
            </p>
            <p className="font-light text-lg">
              To achieve academic excellence through evolutionary vision,
              critical thinking and effective decision making.
            </p>
            <p className="font-light text-lg">
              To facilitate learning among the pupils using appropriate
              methodologies and enhance their skills to render selfless service
              to the community.
            </p>
          </div>
        </motion.div>
      ...
      <div className="flex justify-center items-center py-20 my-20 bg-blue-700 transition-all">
        <p className="text-3xl mx-auto max-w-3xl text-center font-thin text-white">
          To train a qualitative renewable talent bank of dedicated, committed
          educators who a r e intellectually well developed, socially concerned
          and morally upright. The focus is on wholesome personality development
          which empowers them. t o address problems faced nationally and
          globally with evolutionary vision, scientific temper andresearch
          oriented mind
        </p>
      </div>
