...
const Hero = ({ heroData }) => {
  ...
  const navigateToAboutUsPage = (e) => {
    e.preventDefault();
    dispatch(setCurrentPath("/" + "about-devSamaj"));
    navigate("/" + "about-devSamaj");
  };
  return (
    <div className="container  my-4 grid grid-cols-1 lg:grid-cols-2 min-h-[650px] relative lg:bg-gradient-to-r lg:from-blue-50 lg:to-white p-6 lg:rounded-2xl lg:shadow-lg">
      {/* Brand Info */}
      <motion.div
