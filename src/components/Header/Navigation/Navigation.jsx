...
const Navigation = () => {
  ...
  const { selectedSchoolName, updateSchoolName } = useSchool();
  ...
  const handleContactClick = (e) => {
    e.preventDefault();
    dispatch(setCurrentPath("/" + 'contact'));
    navigate("/" + 'contact');
  };
            ...
            <div className="flex items-center">
              ...
              <div className={`flex flex-col ${navConfig.navTetxColor}`}>
                ...
                <div className="text-sm font-light flex justify-start items-center gap-2">
                  <GrLocation />
                  <p>{selectedSchoolName === 'nehruNagar' ? 'Nehru Nagar' : 'Sukhdev Nagar'}</p>
                  <a
                    href="#"
